...
function renderEnvelopeMode() {
  ...
  <div class="card">
    ...
    <div class="row">
      ...
      <strong>
        ¥${formatMoney(Math.max(profitTargetCash - BOX_FEE, 0))}
      </strong>
